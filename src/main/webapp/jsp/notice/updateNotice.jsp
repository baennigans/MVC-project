...
<body>
	...
	<section>
		<div class="container">
			...
			<form action="${ pageContext.request.contextPath }/updateNoticeProcess.do" method="post" onsubmit="return checkForm()">
				...
				<table border="1" class="getnotice">
					...
					<tr>
						<td>내용</td>
						<td><textarea name="detail" cols="40" rows="10">${notice.detail}</textarea>
						</td>
					</tr>
					<tr>
						<td>작성자</td>
					...
					<tr>
						<td colspan="2"><input type="submit" value="수정완료" id="updateNotice" /></td>
					</tr>
				</table>
			</form>
